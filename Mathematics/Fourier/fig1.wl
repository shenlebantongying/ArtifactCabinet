...
ClearAll[f1]
f1[t_,kmax_] := Sum[((-1)^k)/k * Sin[k*t],{k,1,kmax}] (* k should be infinity, but this makes plot obvious*)
fig1f=Plot[Evaluate@Table[f1[t,kmax],{kmax,1,11,5}],{t,-5Pi,5Pi},Ticks -> {Range[-5Pi, 5Pi, Pi], Automatic},AspectRatio->1/2];
