...
(run* q (disj2 succeed fail)) ;; => '(_0)

(run* q (disj2 fail fail)) ;; => '()

(run* q (disj2 (== 'a q) (== 'b q))) ;; '(a b)
...
(run* (x y) (disj2 (conj2 (== #f x) (== #t y)) (conj2 (teacupo x) (== #f y))))

(run* (x y) (conde ((== #f x) (teacupo y)) ((teacupo x) (teacupo x))))
;; '((#f tea) (#f cup) (tea _0) (cup _0))

(run* (x y) (conde ((== 'red x) (== 'blue y)) ((== 'white x) (== 'dark y))))
;;'((red blue) (white dark))
